...
START_URL = (
    ...
    "?dispCatNo=100000100070009&fltDispCatNo=&prdSort=01&pageIdx=1&rowsPerPage=24"
    "&searchTypeSort=btn_thumb&plusButtonFlag=N&isLoginCnt=0"
    "&aShowCnt=0&bShowCnt=0&cShowCnt=0"
    "&trackingCd=Cat100000100070009_Small&amplitudePageGubun="
)
