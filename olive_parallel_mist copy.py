...
START_URL = (
    ...
    "?dispCatNo=100000100010010&isLoginCnt=0&aShowCnt=0&bShowCnt=0&cShowCnt=0&gateCd=Drawer"
    "&t_1st_category_type=%EB%8C%80_%EC%8A%A4%ED%82%A8%EC%BC%80%EC%96%B4&t_2nd_category_type=%EC%A4%91_%EB%AF%B8%EC%8A%A4%ED%8A%B8%2F%EC%98%A4%EC%9D%BC"
    ...
    async with async_playwright() as p:
        ...
        for original_item, detail_result in zip(items_to_scrape, results):
            ...
            if isinstance(detail_result, dict):
                ...
                print(f"[DETAIL OK] {original_item['global_index']}: {original_item['product_name'][:30]}...")
            else:
