...
# ── 설정 ─────────────────────────────────────────────────────
# 카테고리: 중_클렌징 (dispCatNo=100000100080006)
START_URL = (
    "https://www.oliveyoung.co.kr/store/display/getMCategoryList.do"
    "?dispCatNo=100000100040008&fltDispCatNo=&prdSort=01&pageIdx=1&rowsPerPage=24"
    "&searchTypeSort=btn_thumb&plusButtonFlag=N&isLoginCnt=0"
    "&aShowCnt=0&bShowCnt=0&cShowCnt=0"
    "&trackingCd=Cat100000100040008_Small&amplitudePageGubun="
)

CATEGORY_PAGE_URL = START_URL
MAX_PAGES_TO_SCRAPE = 27
...
# 타임슬립
SLEEP_BASE = 0.25
SLEEP_JITTER = (0.15, 0.35)
ROW_PAUSE_SEC = 0.6
DETAIL_PAUSE_SEC = 0.6

# 저장 경로
SAVE_DIR = Path.cwd()
SAVE_NAME = "Olive_Hair_Shampoo.csv"
